...
CREATE OR REPLACE FUNCTION "public"."create_admin_profile_secure"("p_user_id" "uuid", "p_name" "text", "p_email" "text", "p_admin_type" "text" DEFAULT 'admin'::"text") RETURNS "void"
...
ALTER FUNCTION "public"."create_admin_profile_secure"("p_user_id" "uuid", "p_name" "text", "p_email" "text", "p_admin_type" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."admins" (
    ...
    "name" "text" NOT NULL,
    "email" "text" NOT NULL,
    "admin_type" "text" DEFAULT 'admin'::"text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "admins_admin_type_check" CHECK (("admin_type" = ANY (ARRAY['admin'::"text", 'super_admin'::"text"])))
);
...
ALTER TABLE ONLY "public"."classes"
    ADD CONSTRAINT "fk_classes_created_by_user" FOREIGN KEY ("created_by_user_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;
...
CREATE POLICY "Allow authenticated users to manage classes" ON "public"."classes" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Allow authenticated users to register as admin" ON "public"."admins" FOR INSERT TO "authenticated" WITH CHECK ((("auth"."uid"() = "user_id") AND ("admin_type" = 'admin'::"text")));
...
CREATE POLICY "Allow authenticated users to update their own profile" ON "public"."admins" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Allow authenticated users to view their own profile" ON "public"."admins" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));
...
GRANT ALL ON FUNCTION "public"."create_admin_profile_secure"("p_user_id" "uuid", "p_name" "text", "p_email" "text", "p_admin_type" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_admin_profile_secure"("p_user_id" "uuid", "p_name" "text", "p_email" "text", "p_admin_type" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_admin_profile_secure"("p_user_id" "uuid", "p_name" "text", "p_email" "text", "p_admin_type" "text") TO "service_role";
