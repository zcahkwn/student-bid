...
CREATE OR REPLACE FUNCTION "public"."auto_select_and_refund_bids"("p_opportunity_id" "uuid") RETURNS "jsonb"
...
ALTER FUNCTION "public"."auto_select_and_refund_bids"("p_opportunity_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."delete_class_atomic"("p_class_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    v_class_name text;
...
ALTER FUNCTION "public"."delete_class_atomic"("p_class_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."remove_student_from_class"("p_user_id" "uuid", "p_class_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
v_student_name text;
...
ALTER FUNCTION "public"."remove_student_from_class"("p_user_id" "uuid", "p_class_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."bids" (
    ...
    CONSTRAINT "bids_bid_status_check" CHECK ((("bid_status")::"text" = ANY (ARRAY[('placed'::character varying)::"text", ('confirmed'::character varying)::"text", ('selected'::character varying)::"text", ('rejected'::character varying)::"text", ('auto_selected'::character varying)::"text"]))),
...
CREATE INDEX "idx_classes_active_created_at" ON "public"."classes" USING "btree" ("is_archived", "created_at") WHERE ("is_archived" = false);
...
CREATE INDEX "idx_classes_is_archived" ON "public"."classes" USING "btree" ("is_archived");
...
CREATE POLICY "Allow anonymous registration" ON "public"."admin_users" FOR INSERT TO "anon" WITH CHECK (true);



CREATE POLICY "Allow authenticated admins to read own data" ON "public"."admin_users" FOR SELECT TO "authenticated" USING ((("auth"."uid"())::"text" = ("id")::"text"));



CREATE POLICY "Allow authenticated admins to update own data" ON "public"."admin_users" FOR UPDATE TO "authenticated" USING ((("auth"."uid"())::"text" = ("id")::"text")) WITH CHECK ((("auth"."uid"())::"text" = ("id")::"text"));
...
CREATE POLICY "Allow service role to read admin data" ON "public"."admin_users" FOR SELECT TO "service_role" USING (true);
...
GRANT ALL ON FUNCTION "public"."auto_select_and_refund_bids"("p_opportunity_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."auto_select_and_refund_bids"("p_opportunity_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."auto_select_and_refund_bids"("p_opportunity_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."delete_class_atomic"("p_class_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."delete_class_atomic"("p_class_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."delete_class_atomic"("p_class_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."remove_student_from_class"("p_user_id" "uuid", "p_class_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."remove_student_from_class"("p_user_id" "uuid", "p_class_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."remove_student_from_class"("p_user_id" "uuid", "p_class_id" "uuid") TO "service_role";
