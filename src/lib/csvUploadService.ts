...
// Function to update student enrollment token status
const updateStudentEnrollmentTokenStatus = async (
  userId: string,
  classId: string,
...
// Function to update student enrollment bidding result
const updateStudentEnrollmentBiddingResult = async (
  userId: string,
  classId: string,
...
const batchUpdateBiddingResults = async (
  classId: string,
  winners: string[], 
  losers: string[]
): Promise<void> => {
